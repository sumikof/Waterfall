...
| REV | REV-001〜REV-004 | このプロジェクトのフェーズ間レビュー報告書 |
...
│   ├── REV/
│   │   ├── REV-001_req-to-bsd.md
│   │   ├── REV-002_bsd-to-dsd.md
│   │   ├── REV-003_dsd-to-imp.md
│   │   └── REV-004_imp-to-test.md
│   └── REL/
...
## フェーズ0（横断）: フェーズ間レビュー (REV)

> **配置先**: すべて `projects/PRJ-{NNN}/REV/`（プロジェクト固有）。各フェーズ完了時に実施する。
>
> **実施タイミング**: 上流フェーズの成果物が揃ったタイミングで、下流フェーズへ移行する前に実施する。

### ドキュメント一覧

| ドキュメントID | ドキュメント名 | ファイル名 | 説明 | 入力元 | 実施タイミング |
|---|---|---|---|---|---|
| REV-001 | REQ→BSDフェーズ間レビュー報告書 | `REV-001_req-to-bsd.md` | REQ成果物とBSD成果物の整合性・FEAT-IDトレーサビリティ検証。次フェーズ（DSD）移行可否判定 | REQ-001〜REQ-008, BSD-001〜BSD-008 | BSD フェーズ完了時 |
| REV-002 | BSD→DSDフェーズ間レビュー報告書 | `REV-002_bsd-to-dsd.md` | BSD成果物とDSD成果物の整合性・FEAT-IDトレーサビリティ検証。次フェーズ（IMP）移行可否判定 | BSD-001〜BSD-008, DSD-001〜DSD-008（FEAT別） | DSD フェーズ完了時 |
| REV-003 | DSD→IMPフェーズ間レビュー報告書 | `REV-003_dsd-to-imp.md` | DSD成果物とIMP成果物の整合性・TDD完了確認・FEAT-IDトレーサビリティ検証。次フェーズ（IT/ST）移行可否判定 | DSD-001〜DSD-008（FEAT別）, IMP-001〜IMP-005 | IMP フェーズ完了時 |
| REV-004 | IMP→IT/STフェーズ間レビュー報告書 | `REV-004_imp-to-test.md` | IMP成果物とIT/ST成果物の整合性・テストカバレッジ・FEAT-IDトレーサビリティ検証。次フェーズ（UAT）移行可否判定 | IMP-001〜IMP-005, IT-001〜IT-003, ST-001〜ST-004 | IT/ST フェーズ完了時 |

### 成果物チェックリスト
- [ ] REV-001 REQ→BSDフェーズ間レビュー報告書（BSD完了後）
- [ ] REV-002 BSD→DSDフェーズ間レビュー報告書（DSD完了後）
- [ ] REV-003 DSD→IMPフェーズ間レビュー報告書（IMP完了後）
- [ ] REV-004 IMP→IT/STフェーズ間レビュー報告書（IT/ST完了後）
